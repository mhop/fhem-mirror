...
sub FRITZBOX_Attr($@)
{
   ...
   if ( ($aName =~ /m3uFileLocal|m3uFileURL/ && $hash->{APICHECKED} == 1) || $aName =~ /disable|INTERVAL|nonblockingTimeOut/ ) {
      FRITZBOX_Log $hash, 5, "DEBUG: Attr $cmd $aName";
      $hash->{APICHECKED} = 0;
      RemoveInternalTimer($hash->{helper}{TimerReadout});
...
#   28 Internetverbindung IPv6 wurde getrennt, Pr‰fix nicht mehr g¸ltig.
#
#   73 Anmeldung der Internetrufnummer <Nummer> war nicht erfolgreich. Ursache: Gegenstelle antwortet nicht. Zeit¸berschreitung.
#   85 Die Internetverbindung wird kurz unterbrochen, um der Zwangstrennung durch den Anbieter zuvorzukommen.
#
#  119 Information des Anbieters ¸ber die Geschwindigkeit des Internetzugangs (verf¸gbare Bitrate): nnnn/nnnn kbit/s
#
#  201 Es liegt keine Stˆrung der Telefonie mehr vor. Alle Rufnummern sind ab sofort wieder verf¸gbar.
#  205 Anmeldung f¸r IP-Telefonieger‰t "Telefonie-Ger‰t" von IP-Adresse ... nicht erfolgreich.
#
...
#  706 [...] WLAN-Ger‰t Anmeldung am Gastzugang gescheitert (n,n GHz): ung¸ltiger WLAN-Schl¸ssel. MAC-Adresse: nn:nn:nn:nn:nn:nn.
#  748 [...] WLAN-Ger‰t angemeldet (n,n GHz), nn Mbit/s, PC-..., IP ..., MAC ... .
#  752 [...] WLAN-Ger‰t hat sich abgemeldet (n,n GHz), PC-..., IP ..., MAC ....
#  754 [...] WLAN-Ger‰t wurde abgemeldet (.,. GHz), PC-..., IP ..., MAC ... .
#  756 WLAN-Ger‰t hat sich neu angemeldet (n,n GHz), nn Mbit/s, Ger‰t, IP ..., MAC ....
...
# 2380 Es besteht keine Verbindung mehr zu den verschl¸sselten DNS-Servern.
# 2383 Es wurde erfolgreich eine Verbindung - samt vollst‰ndiger Validierung - zu den verschl¸sselten DNS-Servern aufgebaut.
# 2380 Es besteht keine Verbindung mehr zu den verschl¸sselten DNS-Servern.

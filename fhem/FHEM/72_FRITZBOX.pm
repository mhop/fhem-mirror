...
<ul>
   ...
   <ul>
      ...
      <li><a name="dectRingblock"></a>
         ...
         lmode:on|off = lmode definiert die Sperre. Bei off ist sie aus, auÃŸer f&uuml;r den angegebenen Zeitraum.<br>
                                                    Bei on ist die Sperre an, auÃŸer f&uuml;r den angegebenen Zeitraum<br>
   ...
   <ul><br>
      ...
      <li><b>box_macFilter_active</b> - Status des WLAN MAC-Filter (WLAN-Zugang auf die bekannten WLAN-Geräte beschr&auml;nken)</li>

###
### special version for testing codemirror integration
### derived from SVN 5080
###
### modified by betateilchen, justme1968, papa and others
###
...
sub FW_codemirrorParams($)
{
  ...
  my $theme = AttrVal($FW_wname,'enhancedEditorTheme','blackboard');
  return "{theme: '". $theme. "', lineNumbers: true, matchBrackets: true, autoCloseBrackets: true, ".

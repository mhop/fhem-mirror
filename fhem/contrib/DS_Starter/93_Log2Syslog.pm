##########################################################################################################################
# $Id: 93_Log2Syslog.pm 17544 2018-10-16 13:00:30Z DS_Starter $
##########################################################################################################################
#       93_Log2Syslog.pm
#
...
our %Log2Syslog_vNotesIntern = (
  "5.3.1"  => "20.10.2018  fix problem get fqdn in rare cases, Forum: https://forum.fhem.de/index.php/topic,75426.msg847943.html#msg847943 ",
...
sub Log2Syslog_setpayload ($$$$$$) { 
  ...
  if(!$hash->{MYFQDN}) {
      eval { $myfqdn = hostfqdn(); };                       # Forum: https://forum.fhem.de/index.php/topic,75426.msg847943.html#msg847943
      $hash->{MYFQDN} = $myfqdn?$myfqdn:$myhost;            # MYFQDN eigener Host (f. IETF)
  }
  $myfqdn = $hash->{MYFQDN};

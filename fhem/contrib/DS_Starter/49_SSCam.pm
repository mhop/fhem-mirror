########################################################################################################################
# $Id: 49_SSCam.pm 17199 2018-08-24 15:20:55Z DS_Starter $
#########################################################################################################################
#       49_SSCam.pm
#
...
#  Versions History:
# 
# 7.1.0  01.09.2018    PIR Sensor enable/disable, SSCam_Set optimized
...
sub SSCam_composegallery ($;$$) { 
  ...
  $htmlCode .= "</table>";
  $htmlCode .= "</div>";
  $htmlCode .= "<a onClick=\"FW_cmd('$FW_ME$FW_subdir?XHR=1&$cmddosnap')\">$imgdosnap </a>" if($strmdev);
  $htmlCode .= "</html>";

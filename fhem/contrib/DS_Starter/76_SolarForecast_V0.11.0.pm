...
my %vNotesIntern = (
  "0.11.0" => "14.03.2021  new attr history_hour, Val1, Val2, changed sub forecastGraphic from Wzut ",
...
sub forecastGraphic {                                                                      ## no critic 'complexity'
  ...
  if ($header) {
    ...
    $type = 'pv' if (AttrVal($name, 'Val1', '') eq AttrVal($name, 'Val2', ''));
